...
public class JsonError extends JsonElement {
	...
	/* (non-Javadoc)
	 * @see json.outline.elements.JsonElement#getChildren()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json.outline.elements.JsonElement#getForegroundColor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json.outline.elements.JsonElement#getImage()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json.outline.elements.JsonElement#getStyledString()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see json.outline.elements.JsonElement#removeFromParent()
	 */
	@Override
